...
export function makeModelMat3(pan, scale, width, height) {
    ...
    modelMat3[0] = domMatrix.a; modelMat3[1] = domMatrix.b; modelMat3[2] = 0;
    modelMat3[3] = domMatrix.c; modelMat3[4] = domMatrix.d; modelMat3[5] = 0;
    modelMat3[6] = domMatrix.e; modelMat3[7] = domMatrix.f; modelMat3[8] = 1;
    return modelMat3;
}